 ...
 *  desc   :
 */
class RoomMessageAdapter(private val mContext: Activity, private val mOnItemClickListener: RecyclerItemClickListener) : AbstractBaseRecyclerAdapter<SipMessage>(mContext) {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {

        var context = LayoutInflater.from(mContext)
        var view = context.inflate(R.layout.item_sip_message_list, parent, false)
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        val date: Date = Date(info.timestamp)
        ...
        if (info.isSend) {
            ...
            holder.tvSend.text = info.message_text
        } else {
            holder.llReceived.visibility = View.VISIBLE
            holder.llSend.visibility = View.GONE
            holder.tvReceived.text = info.message_text
        }
