 ...
 *  desc   :
 */
class AuthenticateSkypeAccountBottomSheet (val mContext: Context) : BottomSheetDialogFragment(), View.OnClickListener {

    private var usernameView: TextInputEditText? = null
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val rootView = LayoutInflater.from(activity).inflate(R.layout.bottom_sheet_authenticate_skype_account, null)
    ...
    private fun initView(rootView: View) {
        ...
        usernameView = rootView.findViewById(R.id.usernameField)
        passwordView = rootView.findViewById(R.id.passwordField)
        authView = rootView.findViewById(R.id.authSkypeView)
