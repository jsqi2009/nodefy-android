 ...
 *  desc   :
 */
class SettingXMPPAccountAdapter(private val mContext: Activity) : AbstractBaseRecyclerAdapter<DialerAccountInfo>(mContext) {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {

        var context = LayoutInflater.from(mContext)
        var view = context.inflate(R.layout.item_setting_xmpp_account_list, parent, false)
    ...
    override fun onBindViewHolder(holder: RecyclerView.ViewHolder, position: Int) {
        ...
        /*holder.itemView.setOnClickListener {
            mOnItemClickListener.onXMPPAccountClick(holder.itemView, position)
        }*/
    }
