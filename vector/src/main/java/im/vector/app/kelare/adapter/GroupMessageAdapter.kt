 ...
 *  desc   :
 */
class GroupMessageAdapter(private val mContext: Activity, private val mOnItemClickListener: RecyclerItemClickListener) : AbstractBaseRecyclerAdapter<GroupMessage>(mContext) {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {

        var context = LayoutInflater.from(mContext)
        var view = context.inflate(R.layout.item_group_message_list, parent, false)
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        var tvReceivedFrom: TextView
        var tvSend: TextView
        var tvSendFrom: TextView
        var lineView: View
        ...
        init {
            ...
            tvReceivedFrom = itemView.findViewById(R.id.tv_received_from)
            tvSend = itemView.findViewById(R.id.tv_send_msg)
            tvSendFrom = itemView.findViewById(R.id.tv_send_from)
