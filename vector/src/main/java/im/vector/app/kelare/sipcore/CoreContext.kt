...
import im.vector.app.kelare.sipcontact.ContactLoader
...
import im.vector.app.kelare.sipcontact.ContactsManager
import org.linphone.core.tools.Log
import org.linphone.mediastream.Version
import im.vector.app.kelare.utils.AudioRouteUtils
...
import im.vector.app.kelare.sipcontact.getContactForPhoneNumberOrAddress
...
class CoreContext(
    ...
    val callErrorMessageResourceId: MutableLiveData<SipCallEvent<String>> by lazy {
    ...
    private fun computeUserAgent() {
        ...
        val userAgent = "$appName/$123($deviceName) LinphoneSDK"
        ...
        core.setUserAgent(userAgent, "123")
    }
    ...
    fun answerCall(call: Call) {
        ...
        params.recordFile = SipUtils.getRecordingFilePathForAddress(call.remoteAddress)
