...
class ContactCallViewModel @AssistedInject constructor(
    ...
    @AssistedFactory
    interface Factory : MavericksAssistedViewModelFactory<ContactCallViewModel, RoomDetailViewState> {
        override fun create(initialState: RoomDetailViewState): ContactCallViewModel
    }

    companion object : MavericksViewModelFactory<ContactCallViewModel, RoomDetailViewState> by hiltMavericksViewModelFactory() {
...
//                R.id.voice_call                -> state.isCallOptionAvailable()
                R.id.voice_call                -> state.isCallOptionAvailable() || state.jitsiState.confId == null || state.jitsiState.hasJoined
