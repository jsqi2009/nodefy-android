...
object BottomDeleteSMSDialog {
    ...
    fun showSheet(
        ...
        val value = context.getString(R.string.dialer_message_delete_group, info.peerUserName)
        tvName.text = value
    ...
    interface OnItemSelected {
        fun onClick(whichButton: Int, info: SipChatRoom)
    }
}
