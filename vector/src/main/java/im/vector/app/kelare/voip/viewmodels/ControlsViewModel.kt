...
class ControlsViewModel : ViewModel() {
    ...
    val goToConferenceParticipantsListEvent: MutableLiveData<SipCallEvent<Boolean>> by lazy {
        MutableLiveData<SipCallEvent<Boolean>>()
    }

    val goToChatEvent: MutableLiveData<SipCallEvent<Boolean>> by lazy {
        MutableLiveData<SipCallEvent<Boolean>>()
    }

    val goToCallsListEvent: MutableLiveData<SipCallEvent<Boolean>> by lazy {
        MutableLiveData<SipCallEvent<Boolean>>()
    }

    val goToConferenceLayoutSettingsEvent: MutableLiveData<SipCallEvent<Boolean>> by lazy {
        MutableLiveData<SipCallEvent<Boolean>>()
    }
    ...
    val goToDialerEvent: MutableLiveData<SipCallEvent<Boolean>> by lazy {
        MutableLiveData<SipCallEvent<Boolean>>()
    }
