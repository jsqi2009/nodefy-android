 ...
 *  desc   :
 */
class AccountContactAdapter(val mContext: Context, data: ArrayList<AccountContactInfo>) : BaseQuickAdapter<AccountContactInfo, BaseViewHolder>(
        R.layout.item_account_contact_list, data
) {
